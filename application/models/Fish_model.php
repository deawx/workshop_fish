...
class Fish_model extends MY_Model {
  ...
  function fish_form($id='',$post='')
  {
    ...
    $this->params['form'] = [
      ...
      'help'=>''],
      ['label'=>form_label(('การเข้าสังคม'),'living_id',array('class'=>'control-label text-right col-sm-3')),
      'input'=>form_dropdown(array('name'=>'living_id','class'=>'form-control'),$this->fish_options('living'),set_value('living_id',$data['living_id'])),
      'help'=>''],
      ['label'=>form_label(('การเลี้ยงปลาในตู้'),'container_id',array('class'=>'control-label text-right col-sm-3')),
