...
class Fish_model extends MY_Model {
  ...
  function fish_form($id='',$post='')
  {
    ...
    $this->params['form'] = [
      ...
      'help'=>''],
      ['label'=>form_label(('ขนาดเต็มวัย'),'fullsize',array('class'=>'control-label text-right col-sm-3')),
      ...
      ['label'=>form_label(('อายุเฉลี่ย'),'fullage',array('class'=>'control-label text-right col-sm-3')),
